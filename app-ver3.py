...
def Dscription():
    if request.method == 'GET':
        ...
        if EmojiId == "1F916":
            if desc_id == 1:
                EmojiDes = "Beep Boop, I am a ____!"
            if desc_id == 2:
                EmojiDes = "Boston dynamics makes ___s!"
            if desc_id == 3:
                EmojiDes = "These things are taking over the world..."
        if EmojiId == "1F3B9":
            if desc_id == 1:
...
def Classification():
    ...
    if request.method == 'GET':
        ...
        basebal_keyword_list = [["bat","baseball","base","home","throw","hurl","throws","spin","ball"],
        ...
        chicken_keyword_list = [["chicken","fried","cold","little","roast","whole","chicken","grilled","roasted","bird"],
        ...
        yarn_keyword_list = [["yarn","ball","bounce","red","knit","colored","long","string","cat","kitty","play"],
        ...
        umbrella_keyword_list = [["umbrella","big","rain","rainy","weather","wet","curve","dome","shape","handle","cane"],
                           ["marry","poppins","black","color","dark","somber","remember","forget","inflate","indoors","wide"],
        ...
        bow_keyword_list = [["bow","arrow","bow and arrow","archery","weapon","crossbow","longbow","archer","robin","robinhood","leather"],
                           ["cap","string","rope","stick","flint","tool","primitive","target","sport","accuracy","whirl"],
        ...
        pig_keyword_list = [["pig","pigs","pink","curly","tail","fat","farm","mud","play","animal","bacon"],
                           ["pork","smart","red","light","snout","nose","live","alive","fatty","faty","living"],
        ...
        candle_keyword_list = [["candle","candles","light","drip","shine","fire","flame","burn","stick","scented","gift"],
                           ...
                           ["candela","taper","lamp","fire","light","wax","flame","candlewick","candlelight","lantern","candlestick"],

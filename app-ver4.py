...
def Classification():
    ...
    if request.method == 'GET':
        ...
        if ((num1 or num2 or num3 or num4 or num5 or num6 or num7 or num8 or num9 or num10 or num11 or num12 or num13 or num14 or num15 or num16 or num17 or num18 or num19 or num20 or num21) > 1):
